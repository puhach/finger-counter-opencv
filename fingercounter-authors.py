...
while True:
    ...
    if num_frames < 60:
        ...
        if hand is not None:
            ...
            # Count the fingers
            fingers, conv_hull = count_fingers(thresholded, hand_segment)

            # Display count
            cv2.putText(frame_copy, str(fingers), (70, 45), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)

            cv2.polylines(frame_copy, pts=[conv_hull+(roi_right,roi_top)], isClosed=True, color=(100,100,100), thickness=2)
